object FToolSolCotizacion: TFToolSolCotizacion
  Left = 54
  Top = 173
  Width = 924
  Height = 98
  Caption = 'FToolSolCotizacion'
  Color = 14869218
  ...
  object pnlAct: TPanel
    ...
    object Label2: TLabel
      ...
      Width = 95
      Height = 15
      Caption = 'Rpt Sol Cotizaci'#243'n'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clNavy
      Font.Height = -11
  ...
  object pprSolCotizacion: TppReport
    ...
    Template.FileName = 'C:\DemaExes\RTMS\LOGSG\Dema\RptSolCotizacion.rtm'
    DeviceType = 'Screen'
